...
public class ParticleSystem {
    ...
    private static final int PARTICLES_START_TIME_COMPONENT_COUNT = 1;

    private static final int TOTAL_COMPONENT_COUNT =
            POSITION_COMPONENT_COUNT + COLOR_COMPONENT_COUNT
                    + VECTOR_COMPONENT_COUNT + PARTICLES_START_TIME_COMPONENT_COUNT;
    ...
    public void bindData(ParticleShaderProgram particleShaderProgram) {
        ...
        vertexArray.setVertexAttribPointer(dataOffset,
                particleShaderProgram.getaParticleStartTimeLocation(), PARTICLES_START_TIME_COMPONENT_COUNT, STRIDE);
    }
